...
<picture>
  ...
  <img src="./banner.svg?v=1" alt="Puneet Sharma — Lead Architect · AI Systems · Tokyo" width="100%">
</picture>
...
Most of my time now goes to the other side of that problem: **agentic
infrastructure that writes, tests and governs software**, and what it takes to
make that trustworthy enough to put near regulated systems.

Based in Tokyo. Mostly writing Python and Java, mostly thinking about failure modes.
...
```
2015 ──── 2018    enterprise monoliths
2018 ──── 2022    microservices, distributed systems
2022 ──── 2024    modular monolith synthesis
2024 ──── now     agentic infrastructure
```
...
<picture>
  ...
  <img src="./stats.svg?v=1" alt="Activity" width="47%">
</picture>
<picture>
  ...
  <img src="./langs.svg?v=1" alt="Languages by share of code" width="47%">
</picture>
...
<sub>Cards on this page are drawn by [`tools/render.py`](./tools/render.py) and refreshed nightly — no badge services involved.</sub>
